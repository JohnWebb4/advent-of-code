...
public class WizardSimulatorTest {
    ...
    public void getMinManaToWin() {
        ...
        assertEquals(953, WizardSimulator.getMinManaToWin(WizardSimulator.Character.getBuilder()
                        .setName("Player")
                        .setActions(playerActions.toArray(WizardSimulator.Action[]::new))
                        .setHitPoints(50)
                        .setMana(500)
    ...
    @Test
    public void getMinManaToWinHard() {
        assertEquals(1289, WizardSimulator.getMinManaToWinHard(WizardSimulator.Character.getBuilder()
                        .setName("Player")
                        .setActions(playerActions.toArray(WizardSimulator.Action[]::new))
                        .setHitPoints(50)
                        .setMana(500)
