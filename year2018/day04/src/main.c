...
static int test_get_strategy_2_best_guard(const char *name, struct libguard_event *const *events, size_t events_length, int expected_id);
...
int main(void)
{
    ...
    is_success &= (test_get_strategy_2_best_guard("Part 2 Test 1", events_test_1, TEST_INPUT_1_LENGTH, 4455) == EXIT_SUCCESS);
    is_success &= (test_get_strategy_2_best_guard("Part 2 Input", events_input, INPUT_LENGTH, 49944) == EXIT_SUCCESS);
...
static int test_get_strategy_2_best_guard(const char *name, struct libguard_event *const *events, size_t events_length, int expected_id)
{
    int result_id = libguard_get_strategy_2_best_guard(events, events_length);
